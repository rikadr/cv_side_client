            ...
            <main className="container ">
                <div > {/* class="fixed hidden inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" id="my-modal" */}
                    <div className="flex flex-col justify-center items-center h-screen text-lg">
                        ...
                        <Link href="/"><button class="transition duration-200 transform hover:translate-x-40 hover:translate-y-40 hover:animate-pulse bg-red-500 hover:bg-green-400 active:bg-green-700 text-white text-lg font-bold py-2 px-4 hover:rounded-full rounded-lg ">Hjem</button></Link>                        
                    </div>
                </div>
            </main>
        </>
