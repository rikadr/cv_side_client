    ...
    <div className="w-80 h-[9rem] md:w-[15rem] md:h-[14.5rem] mt-5 font-titleItal text-e sm:text-g">
      <Link  href="/404">
        <a className="absolute pl-[6.3rem] pt-6 sm:pt-3 md:pt-24 md:pl-3 ">
            <div
            className="w-48 h-24 sm:w-52 sm:h-28 text-white bg-gradient-to-br from-green-400 to-blue-400 hover:to-blue-500 backdrop-blur-sm rounded-full grid content-center justify-center drop-shadow-xl">
            Playground
            </div>
        </a>
      </Link>
